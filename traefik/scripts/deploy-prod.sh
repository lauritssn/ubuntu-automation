...
cp dynamic/prod/systemd/http-prod.socket "$SYSTEMD_USER_DIR/"
cp dynamic/prod/systemd/https-prod.socket "$SYSTEMD_USER_DIR/"
cp dynamic/prod/systemd/traefik-prod.socket "$SYSTEMD_USER_DIR/"
...
cp dynamic/prod/quadlets/traefik-prod.container "$QUADLET_DIR/"
cp dynamic/prod/quadlets/whoami-prod.container "$QUADLET_DIR/"
...
cp dynamic/prod/traefik/traefik.yml "$DEPLOY_DIR/"
...
cp -r dynamic/prod/traefik/dynamic/* "$DEPLOY_DIR/dynamic/prod/"
