...
show_yellow "ufw rule to allow acces to Monitorix from $SECURE_SUBNET_DESC($SECURE_SUBNET) added."
...
cp $CONF_GIT_1 $CONF_ORG_1 && show_yellow "Default Monitorix config file deployed."
...
cp -p $CONF_ORG_2 $CONF_BACK_2 && show_yellow "Config file $CONF_ORG_2 backed up to $CONF_BACK_2."
cp $CONF_GIT_2 $CONF_ORG_2 && show_yellow "Debian Monitorix config file deployed."
...
show_yellow "Monitorix restarted."
