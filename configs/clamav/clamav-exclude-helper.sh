...
echo ""
echo "Critical exclusions to prevent ClamAV scanning itself:"
echo "  --exclude-dir=/var/log           (Log files - prevents lock conflicts)"
echo "  --exclude-dir=/var/lib/clamav    (ClamAV database directory)"
echo "  --exclude-dir=/var/lib/maldet    (Maldet data directory)"
echo "  --exclude-dir=/usr/local/maldetect (Maldet installation)"
echo ""
